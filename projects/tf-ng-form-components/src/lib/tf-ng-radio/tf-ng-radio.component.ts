...
export const CUSTOM_INPUT_VALUE_ACCESSOR: any = {
	...
	useExisting: forwardRef(() => TfNgRadioComponent),
	multi: true
};
...
@Component({
  selector: 'app-tf-ng-radio',
  templateUrl: './tf-ng-radio.component.html',
	styleUrls: ['./tf-ng-radio.component.css'],
	providers: [CUSTOM_INPUT_VALUE_ACCESSOR]
})
export class TfNgRadioComponent implements ControlValueAccessor {
