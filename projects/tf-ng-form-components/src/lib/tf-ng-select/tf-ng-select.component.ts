...
export const CUSTOM_INPUT_VALUE_ACCESSOR: any = {
	...
	useExisting: forwardRef(() => TfNgSelectComponent),
	multi: true
};
...
@Component({
  selector: 'tf-ng-select',
  templateUrl: './tf-ng-select.component.html',
	styleUrls: ['./tf-ng-select.component.css'],
	providers: [CUSTOM_INPUT_VALUE_ACCESSOR]
})
export class TfNgSelectComponent implements ControlValueAccessor {
